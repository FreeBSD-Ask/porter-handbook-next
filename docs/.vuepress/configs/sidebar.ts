...
export const sideBarConfig: SidebarConfig = [
  ...
  },
  {
    ...
    children: [
		...
		'/di-17-zhang-shi-yong-uses-hong/17.21.-fakeroot.md',
		'/di-17-zhang-shi-yong-uses-hong/17.22.-fam.md',
		'/di-17-zhang-shi-yong-uses-hong/17.23.-firebird.md',
		'/di-17-zhang-shi-yong-uses-hong/17.24.-fonts.md',
		'/di-17-zhang-shi-yong-uses-hong/17.25.-fortran.md',
		'/di-17-zhang-shi-yong-uses-hong/17.26.-fuse.md',
		'/di-17-zhang-shi-yong-uses-hong/17.27.-gem.md',
		'/di-17-zhang-shi-yong-uses-hong/17.28.-gettext.md',
		'/di-17-zhang-shi-yong-uses-hong/17.29.-gettext-runtime.md',
		'/di-17-zhang-shi-yong-uses-hong/17.30.-gettext-tools.md',
		'/di-17-zhang-shi-yong-uses-hong/17.31.-ghostscript.md',
		'/di-17-zhang-shi-yong-uses-hong/17.32.-gl.md',
		'/di-17-zhang-shi-yong-uses-hong/17.33.-gmake.md',
		'/di-17-zhang-shi-yong-uses-hong/17.34.-gnome.md',
		'/di-17-zhang-shi-yong-uses-hong/17.35.-go.md',
		'/di-17-zhang-shi-yong-uses-hong/17.36.-gperf.md',
		'/di-17-zhang-shi-yong-uses-hong/17.37.-grantlee.md',
		'/di-17-zhang-shi-yong-uses-hong/17.38.-groff.md',
		'/di-17-zhang-shi-yong-uses-hong/17.39.-gssapi.md',
		'/di-17-zhang-shi-yong-uses-hong/17.40.-horde.md',
		'/di-17-zhang-shi-yong-uses-hong/17.41.-iconv.md',
		'/di-17-zhang-shi-yong-uses-hong/17.42.-imake.md',
		'/di-17-zhang-shi-yong-uses-hong/17.43.-kde.md',
		'/di-17-zhang-shi-yong-uses-hong/17.44.-kmod.md',
		'/di-17-zhang-shi-yong-uses-hong/17.45.-lha.md',
		'/di-17-zhang-shi-yong-uses-hong/17.46.-libarchive.md',
		'/di-17-zhang-shi-yong-uses-hong/17.47.-libedit.md',
		'/di-17-zhang-shi-yong-uses-hong/17.48.-libtool.md',
		'/di-17-zhang-shi-yong-uses-hong/17.49.-linux.md',
		'/di-17-zhang-shi-yong-uses-hong/17.50.-localbase.md',
		'/di-17-zhang-shi-yong-uses-hong/17.51.-lua.md',
		'/di-17-zhang-shi-yong-uses-hong/17.52.-lxqt.md',
		'/di-17-zhang-shi-yong-uses-hong/17.53.-magick.md',
		'/di-17-zhang-shi-yong-uses-hong/17.54.-makeinfo.md',
		'/di-17-zhang-shi-yong-uses-hong/17.55.-makeself.md',
		'/di-17-zhang-shi-yong-uses-hong/17.56.-mate.md',
		'/di-17-zhang-shi-yong-uses-hong/17.57.-meson.md',
		'/di-17-zhang-shi-yong-uses-hong/17.58.-metaport.md',
		'/di-17-zhang-shi-yong-uses-hong/17.59.-minizip.md',
		'/di-17-zhang-shi-yong-uses-hong/17.60.-mysql.md',
		'/di-17-zhang-shi-yong-uses-hong/17.61.-mono.md',
		'/di-17-zhang-shi-yong-uses-hong/17.62.-motif.md',
		'/di-17-zhang-shi-yong-uses-hong/17.63.-ncurses.md',
		'/di-17-zhang-shi-yong-uses-hong/17.64.-ninja.md',
		'/di-17-zhang-shi-yong-uses-hong/17.65.-objc.md',
		'/di-17-zhang-shi-yong-uses-hong/17.66.-openal.md',
		'/di-17-zhang-shi-yong-uses-hong/17.67.-pathfix.md',
		'/di-17-zhang-shi-yong-uses-hong/17.68.-pear.md',
		'/di-17-zhang-shi-yong-uses-hong/17.69.-perl5.md',
		'/di-17-zhang-shi-yong-uses-hong/17.70.-pgsql.md',
		'/di-17-zhang-shi-yong-uses-hong/17.71.-php.md',
		'/di-17-zhang-shi-yong-uses-hong/17.72.-pkgconfig.md',
		'/di-17-zhang-shi-yong-uses-hong/17.73.-pure.md',
		'/di-17-zhang-shi-yong-uses-hong/17.74.-pyqt.md',
		'/di-17-zhang-shi-yong-uses-hong/17.75.-python.md',
		'/di-17-zhang-shi-yong-uses-hong/17.76.-qmail.md',
		'/di-17-zhang-shi-yong-uses-hong/17.77.-qmake.md',
		'/di-17-zhang-shi-yong-uses-hong/17.78.-qt.md',
		'/di-17-zhang-shi-yong-uses-hong/17.79.-qt-dist.md',
		'/di-17-zhang-shi-yong-uses-hong/17.80.-readline.md',
		'/di-17-zhang-shi-yong-uses-hong/17.81.-samba.md',
		'/di-17-zhang-shi-yong-uses-hong/17.82.-scons.md',
		'/di-17-zhang-shi-yong-uses-hong/17.83.-shared-mime-info.md',
		'/di-17-zhang-shi-yong-uses-hong/17.84.-shebangfix.md',
		'/di-17-zhang-shi-yong-uses-hong/17.85.-sqlite.md',
		'/di-17-zhang-shi-yong-uses-hong/17.86.-ssl.md',
		'/di-17-zhang-shi-yong-uses-hong/17.87.-tar.md',
		'/di-17-zhang-shi-yong-uses-hong/17.88.-tcl.md',
		'/di-17-zhang-shi-yong-uses-hong/17.89.-terminfo.md',
		'/di-17-zhang-shi-yong-uses-hong/17.90.-tk.md',
		'/di-17-zhang-shi-yong-uses-hong/17.91.-uidfix.md',
		'/di-17-zhang-shi-yong-uses-hong/17.92.-uniquefiles.md',
		'/di-17-zhang-shi-yong-uses-hong/17.93.-varnish.md',
		'/di-17-zhang-shi-yong-uses-hong/17.94.-webplugin.md',
		'/di-17-zhang-shi-yong-uses-hong/17.95.-xfce.md',
		'/di-17-zhang-shi-yong-uses-hong/17.96.-xorg.md',
		'/di-17-zhang-shi-yong-uses-hong/17.97.-xorg-cat.md',
		'/di-17-zhang-shi-yong-uses-hong/17.98.-zip.md',
    ],
  },
  {
